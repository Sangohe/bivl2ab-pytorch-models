...
from utils.preprocessing import (
    read_image,
    get_label_from_path,
    get_patient_id_from_path,
    get_eye_laterality_from_path,
)


class EyesDataset(Dataset):
    def __init__(self, patient_dirs: List[str], transform: Optional[Any] = None):
        ...
        for patient_dir in patient_dirs:
            patient_frame_paths = [
                os.path.join(patient_dir, p) for p in os.listdir(patient_dir)
            ]
